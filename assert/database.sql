...
(
    `id`               bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `memoryId`         varchar(128)        NOT NULL DEFAULT '' COMMENT '记忆ID',
    `userId`           varchar(128)        NOT NULL DEFAULT '' COMMENT '用户ID',
    `summary`          text                NOT NULL COMMENT '摘要',
    `raw_dialog_array` text                NOT NULL COMMENT '对话的JSON格式，包括了节点的输入输出等',
    `createTime`       datetime            NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `updateTime`       datetime            NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (`id`),
...
(
    ...
    `output`     text                NOT NULL COMMENT '输出内容',
    `createTime` datetime            NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `updateTime` datetime            NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (`id`),
...
(
    `id`           bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `nodeId`       varchar(128)        NOT NULL DEFAULT '' COMMENT '节点ID',
    `nodeName`     varchar(256)        NOT NULL DEFAULT '' COMMENT '节点名称',
    `executor`     varchar(50)         NOT NULL DEFAULT '' COMMENT '执行器: robot / brain',
    `type`         varchar(128)        NOT NULL DEFAULT '' COMMENT '节点类型',
    `description`  text                NOT NULL COMMENT '描述',
    `inputSchema`  text                NOT NULL COMMENT '输入模式',
    `outputSchema` text                NOT NULL COMMENT '输出模式',
    `timeout`      int(11)             NOT NULL DEFAULT '-1' COMMENT '超时时间(秒)，-1表示无超时',
    `extra`        text                NOT NULL COMMENT '附加信息，是map的json表达',
    `createTime`   datetime            NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `updateTime`   datetime            NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (`id`),
